...
<template>
  <div class="flex flex-col flex-1">
    <section class="flex flex-col items-center justify-center min-h-[calc(100vh-68px)]">
      ...
      <div class="max-w-[500px] mt-4">
        ...
        <div class="flex justify-center gap-4 mt-4">
          ...
          <UButton color="gray" label="Read More" />
        </div>
      </div>
    </section>

    <section class="min-h-[calc(100vh-116px)] bg-gray-100 dark:bg-gray-900 flex flex-col justify-center items-center">
      <h1 class="text-2xl font-bold text-center">Ini Section Baru</h1>
    </section>
  </div>
</template>
